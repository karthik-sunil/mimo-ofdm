...
void  rmaPropagate2_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate3_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate4_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate4_r_dve_daidir (UB  * pcode);
void  rmaPropagate4_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate5_r_dve_daidir (UB  * pcode);
void  rmaPropagate5_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate6_r_dve_daidir (UB  * pcode);
