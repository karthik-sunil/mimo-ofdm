...
extern "C" {
#endif
void  rmaPropagate0_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate0_r_dve_daidir (UB  * pcode);
void  rmaPropagate0_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate1_r_dve_daidir (UB  * pcode);
void  rmaPropagate1_t0_dve_daidir (UB  * pcode, UB  val);
void  rmaPropagate1_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate6_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate7_r_dve_daidir (UB  * pcode);
void  rmaPropagate7_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate8_r_dve_daidir (UB  * pcode);
void  rmaPropagate8_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_t0_dve_daidir (UB  * pcode, UB  val);
void  rmaPropagate11_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate11_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate11_r_dve_daidir (UB  * pcode);
void  rmaPropagate11_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate12_r_dve_daidir (UB  * pcode);
void  rmaPropagate12_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate13_r_dve_daidir (UB  * pcode);
void  rmaPropagate13_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate15_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate16_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate16_r_dve_daidir (UB  * pcode);
void  rmaPropagate16_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate17_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate17_r_dve_daidir (UB  * pcode);
void  rmaPropagate17_wn_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_p_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_dve_daidir (UB  * pcode, scalar  val);
void  rmaPropagate18_f_dve_daidir (UB  * pcode, scalar  val, U  I620, scalar  * I1483, U  did);
void  rmaPropagate18_r_dve_daidir (UB  * pcode);
void  rmaPropagate18_wn_dve_daidir (UB  * pcode, scalar  val);
