% for generating the modulated sine wave with the carrier wave of desired frequency in Hz
...
scaled_values = round(mixed_signal * scaling_factor); % FP representation
...
% FFT of the original mixed wave
...
% FFT of the fixed-point mixed wave
