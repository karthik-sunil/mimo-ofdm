function fft_file_processor(input_file, output_file)
    ...
    for chunk = 1:num_chunks
        ...
        % Perform FFT for the current chunk
...
function print_complex(z)
    ...
    real_scaled = round(real(z) * 256); 
    imag_scaled = round(imag(z) * 256);
...
fft_file_processor('a1s0s_inputsine128.txt', 'a1s0s_fftoutputsine128.txt');
