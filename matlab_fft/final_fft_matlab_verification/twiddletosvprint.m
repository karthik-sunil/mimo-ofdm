...
N = 8;
% looping upto N values for upto that power twiddle factors to be generated
% modify the upper limit below to generate appropriate number of twiddle factor files in assign format to be included in code
for loop = 1:10
    no = 8*2^(loop-1);
