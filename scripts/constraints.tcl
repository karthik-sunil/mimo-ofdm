...
set_input_delay -max [expr $clock_period * 0.020] [get_ports -filter "direction == in" a*] -clock core_clk 
set_input_delay -min [expr $clock_period * 0.010] [get_ports -filter "direction == in" a*] -clock core_clk
set_input_delay -max [expr $clock_period * 0.020] [get_ports -filter "direction == in" b*] -clock core_clk
set_input_delay -min [expr $clock_period * 0.010] [get_ports -filter "direction == in" b*] -clock core_clk
set_output_delay -max [expr $clock_period * 0.030] [get_ports -filter "direction == out" c*] -clock core_clk
set_output_delay -min [expr $clock_period * 0.020] [get_ports -filter "direction == out" c*] -clock core_clk
set_output_delay -max [expr $clock_period * 0.025] [get_ports -filter "direction == out" mo*] -clock core_clk
